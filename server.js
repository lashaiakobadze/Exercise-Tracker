...
const PW=lasha123321;
const mongoose = require("mongoose");
let uri =
  "mongodb+srv://Lasha_Iakobadze:" +
  process.env.PW +
  "@freecodecamp.ytjr4.mongodb.net/db1?retryWrites=true&w=majority";
...
let Session=new mongoose('Session',exerciseSessionSchema);
let User=new mongoose('User',userSchema);
